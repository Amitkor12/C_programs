...
int main() 
{
    queue_t* cir_queue = create_queue(5);

    int ret = queue_empty(cir_queue);
    printf("%d\n",ret);

    int ret1 = queue_enqueue(cir_queue,25);
    printf("%d\n",ret1);

    int ret2 = queue_enqueue(cir_queue,35);
    printf("%d\n",ret2);
    
    int ret3 = queue_enqueue(cir_queue,45);
    printf("%d\n",ret3);
    
    int ret4 = queue_enqueue(cir_queue,55);
    printf("%d\n",ret4);
    
    int ret5 = queue_enqueue(cir_queue,65);
    printf("%d\n",ret5);
    
    int ret6 = queue_enqueue(cir_queue,75);
    printf("%d\n",ret6);
    
    int ret7 = queue_enqueue(cir_queue,85);
    printf("%d\n",ret7);

    int ret10 = queue_dequeue(cir_queue);
    printf("%d",ret10);
